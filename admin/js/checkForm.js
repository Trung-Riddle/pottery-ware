...
if (document.querySelector("#addCate")) {
  document.querySelector("#addCate").onclick = (e) => {
    var cateName = document.getElementById("name-category");
    var error = false;
    var checkCateName = "";

    //* Check confirm password
    if (cateName.value == "") {
      checkCateName = checkError("Tên danh mục không được bỏ trống.");
      error = true;
    }
    ...
    if (error == true) {
      e.preventDefault();
      document.querySelector(".textError").innerHTML = checkCateName;
    } else {
