    ...
    <section id="header">
        <div class="containerr">
            <div class="header-text">
                ...
                <p>Chúng tôi – những con người có niềm say mê
                    đặc biệt với nghệ thuật gốm<br> đã nỗ
                    lực hết mình để thành lập POTTERY WARE.
                    Đây là nơi để những “con tim có tình yêu gốm sứ mãnh liệt”
                    tìm được bến đỗ và hội tụ bên nhau, cùng phát triển thương hiệu gốm
                    vươn ra thị trường Thế giới...
                </p>
                <button class="common-btn">Xem thêm</button>
                <div class="line">
